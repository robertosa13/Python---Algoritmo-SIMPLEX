...
set_I = range(1, n+1)
set_J = range(1, m+1)
c = {(i,j): random.normalvariate(0,50) for i in set_I for j in set_J}
a = {(i,j): random.normalvariate(0,1) for i in set_I for j in set_J}
l = {(i,j): random.randint(0,1) for i in set_I for j in set_J}  #low
u = {(i,j): random.randint(0,1) for i in set_I for j in set_J} #upper
b = {j: random.randint(0,1) for j in set_J}                     #b
